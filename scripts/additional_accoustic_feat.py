...
def get_intensity_attributes(filename, time_step=0., min_time=0., max_time=0., pitch_floor=75.,
...
def get_harmonics_to_noise_ratio_attributes(filename, harmonics_type='preferred', time_step=0.01,
...
def get_glottal_to_noise_ratio_attributes(filename, horizontal_minimum=0., horizontal_maximum=0.,
...
def get_lfcc(filename, lpc_method='autocorrelation', prediction_order=16, window_length=0.025,
